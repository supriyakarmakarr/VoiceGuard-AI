...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,17,24&height=220&section=header&text=VoiceGuard%20AI&fontSize=46&fontColor=ffffff&animation=twinkling&fontAlignY=36&desc=Real-Time%20Neural%20Voice%20Deepfake%20%26%20Clone%20Forensic%20Defense&descAlignY=58&descSize=16" width="100%"/>
...
| Role | Focus |
|:---|:---|
| ML / DSP Specialist | Preprocessing & 142-feature extraction |
| Deep Learning Engineer | ResNet-SE CNN architecture & training |
| Backend Architect | FastAPI REST & streaming endpoints |
| Frontend Designer | Cyberpunk dashboard, multilingual UI |
| Streaming Engineer | Web Audio API, live mic capture |
| Security Analyst & Pitch Lead | Risk calibration, benchmarks, audit reports |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,17,24&height=110&section=footer&animation=twinkling" width="100%"/>
